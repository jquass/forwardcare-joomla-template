		...
		if (!empty($this->product->customfieldsCart)) {
			...
			<div class="product-fields">
				...
				<div class="product-field product-field-type-<?php echo $field->field_type ?>">
					<span class="product-fields-title-wrapper"><span class="product-fields-title"><strong><?php echo preg_replace("/\([^)]+\)/","",JText::_ ($field->custom_title)) ?></strong></span>
					<?php if ($field->custom_tip) {
					echo JHTML::tooltip ($field->custom_tip, JText::_ ($field->custom_title), 'tooltip.png');
				} ?></span>
					<span class="product-field-display">
						
						<?php 							$radioDisplay = $field->display;
							$radioDisplay2 = preg_replace( "/\([^)]+\)/","",												str_replace( "No additional charge", "", 												str_replace( "</label>", "</label></br>", $radioDisplay)));
							echo $radioDisplay2;							
						?>
