...
<div class="productdetails-view productdetails">
    ...
    <div>
	<div class="width60 floatleft">	</br>	</br>
<?php
...
?>
	...
	<div class="width40 floatright">
		...
		<?php    if (!empty($this->product->customfieldsSorted['buy-area'])) {					$this->position = 'buy-area';					echo $this->loadTemplate('customfields');					} // Product Custom buy-area end		?>		<?php			echo '<strong>' . JText::_('COM_VIRTUEMART_PRODUCT_UNITS_IN_BOX') . '</strong>' . $this->product->product_box;	    ?>
		<?php
